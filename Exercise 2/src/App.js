...
class App extends React.Component {
  constructor(props)
  {
    ...
    */
    ...
    addFood = (stuffDescription, quantity) => {
    return () =>  {
        ...
        if(searchResult != -1) {
          ...
          this.setState({items: [...this.state.items, { 
              id: this.state.items.lenght + 1, value: stuffDescription, qty: quantity }]});
        }
      }
    }
  ...
  render()
  {
    ...
    return <div className={ styles.shoppingList }>
      ...
      <button onClick= { this.addFood('Yogurt', 2) } >  Add Yogurt </button>
      <button onClick= { this.addFood('Bread', 4) } > Add Bread </button>
